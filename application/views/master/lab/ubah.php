    ...
    <form action="" method="post">
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <input type="text" name="nama_lab" id="nama_lab" class='form-control mb-3' value="<?= $data["nama_lab"] ;?>">
            ...
            <div class="col-lg-6">
                ...
                <input type="text" name="nama_lain" id="nama_lain" class='form-control mb-3' value="<?= $data["nama_lain"] ;?>">
