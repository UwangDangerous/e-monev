    ...
    <form action="" method="post">
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <select name="id_kelas" id="id_kelas" class='form-control mb-3'>
                    ...
                    <?php foreach ($kelas as $k) : ?>
                        <?php if($data['id_kelas'] == $k['id_kelas']) : ?>
            ...
            <div class="col-lg-6">
                ...
                <input type="text" name="zat_aktif" id="zat_aktif" class='form-control mb-3' value="<?= $data["zat_aktif"] ;?>">
            ...
            <div class="col-lg-6">
                ...
                <input type="text" name="jenis_sedian" id="jenis_sedian" class='form-control mb-3' value="<?= $data["jenis_sedian"] ;?>">
            ...
            <div class="col-lg-6">
                ...
                <input type="text" name="bentuk_sedian" id="bentuk_sedian" class='form-control mb-3' value="<?= $data["bentuk_sedian"] ;?>">
            ...
            <div class="col-lg-6">
                ...
                <input type="text" name="pustaka" id="pustaka" class='form-control mb-3' value="<?= $data["pustaka"] ;?>">
            ...
            <div class="col-lg-6">
                ...
                <input type="text" name="parameter" id="parameter" class='form-control mb-3' value="<?= $data["parameter"] ;?>">
